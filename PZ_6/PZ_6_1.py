...
while True:  # обработка исключений
    try:
        a1, b1, n, k = int(input('Введите дипазон целого числа A: ')), int(input('Введите дипазон целого числа B: ')), \
                       int(input('Введите последовательность чисел N: ')), int(input('Введите челое число K: '))
        # ввод чисел
        break
    except ValueError:
